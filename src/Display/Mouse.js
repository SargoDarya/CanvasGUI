...
GUI.Mouse.prototype.getNormalizedPosition = function()
{
...
GUI.Mouse.prototype.position = function(x, y)
{
...
GUI.Mouse.prototype.injectMoveEvent = function(evt) {
  this._evt = evt;
...
GUI.Mouse.prototype._updatePosition = function() {
...
GUI.Mouse.prototype.setRelative = function() {
  this._movement = "relative";
};

GUI.Mouse.prototype.setAbsolute = function() {
  this._movement = "absolute";
};

GUI.Mouse.prototype.getMovement = function() {
